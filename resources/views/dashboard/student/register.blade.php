...
@section('content')
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-lg-6 col-md-6 d-none d-md-block infinity-image-container" style="background: url('{{ asset('assets/img/bg2.png') }}') center no-repeat;"></div>
			<!-- IMAGE CONTAINER END -->
			...
			<div class="col-lg-6 col-md-6 infinity-form-container">
				...
				<div class="col-lg-9 col-md-12 col-sm-8 col-xs-12 infinity-form">
					...
					<!-- Form -->
					<form class="px-5" method="POST" action="{{ route('student.create') }}">
                        @csrf
						<!-- Input Box -->
